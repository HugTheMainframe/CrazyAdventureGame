public class Maps {
    ...
    public Maps() {
        room1 = new Rooms("\"Dungeon\": ", "Entering the dungeon, the air grows heavy with the stench of decay.\n" +
        ...
        room2 = new Rooms("\"Prison\": " , "Emerging from the dungeon's depths, I find myself in a desolate prison,\n" +
        ...
        room3 = new Rooms("\"Cave\": " , "Venturing beyond the prison's confines, \n" +
        ...
        room4 = new Rooms("\"Forest\": " , "Emerging from the dungeon's embrace, \n" +
        ...
        room5 = new Rooms("\"Creek\": " , "Following the winding path through the basement, \n" +
        ...
        room6 = new Rooms("\"Sprawling City\": " , "Exiting the cave, I arrive at the outskirts of a sprawling city, \n" +
        ...
        room7 = new Rooms("\"Castle\": " , "Approaching the city's center, \n" +
        ...
        room8 = new Rooms("\"Basement\": " , "Descending into the depths of the castle, I find myself in a dimly lit basement, \n" +
        ...
        room9 = new Rooms("\"Catacombs\": " , "Delving deeper into the bowels of the castle, \n" +
